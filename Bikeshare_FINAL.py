...
def get_filters():
    ...
    # get user input for city (chicago, new york city, washington). This will prompt the input of one of the three cities in city_list. If more are added, only the top three will appear.
